...
The current version of the script requires Freesurfer processed files (recon-all) for ventricular segmentation. After running recon-all, you can get the choroid plexus s